...
public class ProtectCameraFromWallClip : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isC)
        {
            pivot.transform.localPosition = new Vector3(pivot.transform.localPosition.x, 0.5f, pivot.transform.localPosition.z);
        }
        else
        {
            pivot.transform.localPosition = new Vector3(pivot.transform.localPosition.x, 1.6f, pivot.transform.localPosition.z);
        }
    }
